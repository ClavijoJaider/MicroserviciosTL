...
namespace WayBankClient.service
{
    ...
    internal interface IServicePeticiones
    {
        ...
        /// <summary>
        /// Consulta personalizada #2 — datos del maestro + 2 agregados del detalle.
        /// COUNT movimientos y SUM créditos de la cuenta indicada.
        /// GET /cuentas/{numero}/resumen en MS-CuentaAhorros (8080).
        /// </summary>
        ResumenCuentaDto ObtenerResumen(int numeroCuenta);
